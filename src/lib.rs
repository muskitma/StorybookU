...
#[derive(Debug)]
pub struct StorybookUIProcessor {
    verbose: bool,
    processed_count: usize,
}

impl StorybookUIProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting StorybookUI processing");
    
    let mut processor = StorybookUIProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = StorybookUIProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = StorybookUIProcessor::new(false);
